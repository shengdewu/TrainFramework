...
class EMA:
    ...
    def update(self, parameters: Iterable[torch.nn.Parameter]) -> None:
        ...
        vt = (1-beta) * param + beta * shadow
        vt = param + (shadow - param) * beta
        """
        ...
        with torch.no_grad():
            ...
            for shadow, param in zip(self.shadow_params, parameters):
                ...
                shadow - tmp * (1 - beta)
                -> shadow - (shadow - param) + (shadow - param) * beta = vt
