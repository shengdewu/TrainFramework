...
class TrainingSampler(Sampler):
    ...
    def __init__(self, size: int, shuffle: bool = True, seed: Optional[int] = None, rank=None, world_size=None):
        """
        Args:
        ...
        self._rank = comm.get_rank() if rank is None else rank
        self._world_size = comm.get_world_size() if world_size is None else world_size
...
class GroupSampler(Sampler):
    ...
    def __init__(self, dataset, samples_per_gpu=1, rank=None, world_size=None):
